...
export class ToolSummaryToStoreItemTransformer extends BaseTransformerClass<ToolSummary, ToolStoreItem> {
  transform(toolSummary: ToolSummary): ToolStoreItem {
    return {
      ...
      description: TransformUtils.sanitizeString(toolSummary.description_zh || toolSummary.description, 'Sin descripción'),
      ...
      category: TransformUtils.sanitizeString(toolSummary.category, 'Otros'),
      ...
      icon: '🔧',
      screenshots: [],
      longDescription: TransformUtils.sanitizeString(toolSummary.description, 'Sin descripción'),
      requirements: [],
      changelog: '',
      methods: [],
...
export class ToolResponseToAiToolTransformer extends BaseTransformerClass<ToolResponse, AiTool> {
  transform(toolResponse: ToolResponse): AiTool {
    return {
      ...
      description: TransformUtils.sanitizeString(toolResponse.description_zh || toolResponse.description, 'Sin descripción'),
